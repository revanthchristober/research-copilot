...
async function callRails(path, init) {
...
server.registerTool("search_interviews", {
...
server.registerTool("find_pain_points", {
...
server.registerTool("find_feature_requests", {
...
server.registerTool("ask_research_question", {
